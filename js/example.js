(function(){
  ...
  $('.bottom').stop().animate({opacity:"1"});
  if($(this).attr('id')=='e1')
  {
    $('#i1').stop().animate({opacity:"0"});
    $('.exampleDetail').css("visibility","visible");
    ...
    $('.exampleDetail').stop().animate({opacity:"1"});
  }
  if($(this).attr('id')=='e2')
  {
    $('#i2').stop().animate({opacity:"0"});
    $('.exampleDetail').css("visibility","visible");
  ...
  if($(this).attr('id')=='e1')
  {
    $('#i1').stop().animate({opacity:"1"});
    $('.exampleDetail').stop().animate({opacity:"0"});
    $('.exampleDetail').css("visibility","hidden");
  }
  if($(this).attr('id')=='e2')
  {
    $('#i2').stop().animate({opacity:"1"});
    $('.exampleDetail').stop().animate({opacity:"0"});
    $('.exampleDetail').css("visibility","hidden");
  }
  if($(this).attr('id')=='e3')
  {
    $('#i3').stop().animate({opacity:"1"});
    $('.exampleDetail').stop().animate({opacity:"0"});
    $('.exampleDetail').css("visibility","hidden");
  }
  if($(this).attr('id')=='e4')
  {
    $('#i4').stop().animate({opacity:"1"});
    $('.exampleDetail').stop().animate({opacity:"0"});
    $('.exampleDetail').css("visibility","hidden");
  }
  if($(this).attr('id')=='e5')
  {
    $('#i5').stop().animate({opacity:"1"});
    $('.exampleDetail').stop().animate({opacity:"0"});
    $('.exampleDetail').css("visibility","hidden");
  }
  });
